...
- Install **Codex OMP Subagent** to delegate complex refactoring and multi-tool
  tasks to an external **OMP (Oh My Pi)** harness instance (configured with Gemini 3.7 Flash, Claude, etc.). V2 launches OMP from the native child instead of a `SubagentStart` Hook.
